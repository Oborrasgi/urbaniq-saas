            ...
            <div className="w-full">
              ...
              <div className="mt-6 flex items-center gap-6">
                <Link
                  ...
                  className="scale-100 transition-all duration-300 hover:scale-95"
                >
                  <svg
                ...
                <Link
                  ...
                  className="text-muted-foreground hover:text-foreground scale-100 transition-all duration-300 hover:scale-95"
                >
                  <svg
                    viewBox="0 0 24 24"
                    className="fill-muted-foreground hover:fill-text-foreground size-5 transition-colors"
      ...
      <ul className="space-y-2">
        {links.map((link) => (
          <li key={link.name}>
            <Link
              href={link.href}
              className="text-muted-foreground hover:text-foreground transition-all duration-300 hover:pl-1"
            >
              {link.name}
            </Link>
          </li>
